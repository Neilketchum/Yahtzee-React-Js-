...
const threeOfKind = new SumDistro({ count: 3,description:"Sum all dice if three are the same" });
...
const smallStraight = new SmallStraight({score:25,description:"30 pts for a small straight"});
